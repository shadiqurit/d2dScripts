...
CREATE TABLE HR_EMPCHANGE_kpi2025IPI
AS
    SELECT * FROM HR_EMPCHANGE;

CREATE TABLE HR_EMPINCR_DET_kpi2025IPI
AS
    SELECT * FROM HR_EMPINCR_DET;

CREATE TABLE HR_EMPSALSTRUCTURE_kpi2025IPI
AS
    SELECT * FROM HR_EMPSALSTRUCTURE;

CREATE TABLE kpi_reward2025IPI
AS
    SELECT * FROM kpi_reward;
    
DELETE FROM kpi_reward;  

CREATE OR REPLACE PROCEDURE p_insert_pm_subactrndet
IS
...
BEGIN
   ...
   -- Log the result
   DBMS_OUTPUT.put_line (
      'Successfully inserted ' || v_insert_count || ' fresh rows from PM_SUBACTRNDET');
   DBMS_OUTPUT.put_line (
